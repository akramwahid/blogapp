                    ...
                    <div class="row float-e-margins">
                        ...
                        <div class="col-md-2 col-sm-12 col-xs-12">
                            <router-link :to="{name: 'post', params: {post: post.id }}"
                                ...
                                <i class="fa fa-arrow-left"></i> DISCARD & BACK
                            </router-link>
                        </div>

                        <div class="col-md-2 col-sm-12 col-xs-12 pull-right">
                            <button type="button" @click="updatePost()" class="btn btn-primary btn-block"><i
                                class="fa fa-save"></i> UPDATE POST
                            </button>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="hpanel">
                            <div class="panel-body">
                                ...
                                <div class="text-center m-t-lg">
                                    <button type="button" @click="updatePost()" class="btn btn-primary px-20"><i
                                        class="fa fa-save"></i> UPDATE POST
                                    </button>
                                </div>
                            </div>
